#' k-groups of multiple Cumulative Incidents Functions (CIF)
#'
#' @description Function for grouping CIF, given a number k,
...
#'  (mean of the cif pertaining to the same group).}
#'  \item{curves}{An object of class \code{survfit} containing the cumulative incidence
#'  functions for each population.}
...
#' #Estimating the CIFs given a number of groups k = 2
